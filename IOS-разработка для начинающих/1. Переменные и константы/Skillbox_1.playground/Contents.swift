...
var name1 = "Username_1", name2 = "Username_2", name3 = "Username_3"
...
// 2: let day = (hours: 23, minutes: 59, seconds: 59)

// 3: let geo = (place: "Place", latitude: 55.7477414, longitude: 37.538456, static: true)
